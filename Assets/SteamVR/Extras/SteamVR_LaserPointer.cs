...
namespace Valve.VR.Extras
{
    public class SteamVR_LaserPointer : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                pointer.transform.localScale = new Vector3(thickness * 5f, thickness * 5f, rayLen);
                pointer.GetComponent<MeshRenderer>().material.color = clickColor;
            }
            else
            {
                pointer.transform.localScale = new Vector3(thickness, thickness, rayLen);
                pointer.GetComponent<MeshRenderer>().material.color = color;
            }
            pointer.transform.localPosition = new Vector3(0f, 0f, rayLen / 2f);
        }
    }
